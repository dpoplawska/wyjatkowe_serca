...
export default function Footer() {
	const addressLink =
		"https://www.google.com/maps/place/al.+Jerozolimskie+123A,+02-017+Warszawa/@52.2249832,20.988533,17z/data=!3m1!4b1!4m6!3m5!1s0x471ecc912dcfbc11:0x914920fa7b955f73!8m2!3d52.2249832!4d20.9911079!16s%2Fg%2F11bw3wtd2n?entry=ttu";
				...
				<div className="row">
					<div className="col-12 col-sm-12 col-md-4 mb-3 mb-md-0 ">
						<img
							src={logo}
							className="bear"
							alt="Logo Fundacji Wyjątkowe Serca"
						/>
					</div>
					<div className="col-12 col-sm-12 col-md-4 mb-3 mb-md-0">
						<h5>Kontakt</h5>
				...
				<div className="container">
					<footer className="d-flex flex-wrap justify-content-between align-items-center py-1 my-2 border-top">
						...
						<div className="nav col-md-6 justify-content-end d-flex">
							<span className="mb-3 mb-md-0 text-body-secondary all-rights-reserved">
								© {currentYear} Fundacja Wyjątkowe Serca. Wszystkie prawa
								zastrzeżone.
							</span>
						</div>
					</footer>
