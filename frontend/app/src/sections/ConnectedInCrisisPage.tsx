				...
				<div className="col-xs-12 col-lg-7" id="fundraiser-content">
					<div className="content">
						<div className="crisisHeader">
							<b>Połączeni w kryzysie </b>- jak skutecznie działać, gdy sytuacja
						...
						<p>
							...
							reagować w sytuacjach konfliktowych. Wzmocniono również współpracę
