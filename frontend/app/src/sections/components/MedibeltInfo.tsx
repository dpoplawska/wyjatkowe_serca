...
const MediBelt = ({ productPrice }: MediBeltProps) => {
	...
	return (
		<>
			...
			<p>
				MediBelt lub potocznie <strong>Ratujka</strong> – to apteczka pierwszej
				pomocy w formie wygodnej nerki. Bądź przygotowany na każdą przygodę –
				zarówno tę wesołą, jak i tę wymagającą szybkiej reakcji. Dzięki formie
				praktycznej nerki nosisz ją wygodnie w pasie lub na biodrach, a jej
				ergonomiczny kształt pozwala błyskawicznie sięgnąć po potrzebne
				akcesoria w kryzysowej chwili.
			</p>
			<p>
				Świetnie sprawdzi się w domu, na placu zabaw, w podróży, na spacerze czy
				podczas aktywności na świeżym powietrzu – wszędzie tam, gdzie liczy się
				czas i skuteczność.
			</p>
			...
			<ul style={{ textAlign: "left" }}>
				...
				<li>
					Prontosan Acute Żel – hydrożel przyspieszający gojenie, nawilżający i
					chłodzący
				</li>
			...
			<ul style={{ textAlign: "left" }}>
				...
				<li>
					Bezpieczeństwo – starannie dobrane wyposażenie, także dla dzieci.
				</li>
				<li>
					Wsparcie w stresujących sytuacjach – od drobnych skaleczeń po
					poważniejsze urazy.
				</li>
			</ul>
